...
const FILES = ['/finanzas-procepal/','/finanzas-procepal/index.html','/finanzas-procepal/manifest.json','/finanzas-procepal/icon-192.png','/finanzas-procepal/icon-512.png'];
